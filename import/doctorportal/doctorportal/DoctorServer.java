...
public class DoctorServer implements DoctorService {
    ...
    public DoctorServer() throws RemoteException {
        super();
        initializeData();
        System.out.println("DoctorServer initialized");
    }
    ...
    @Override
    public boolean completeAppointment(DoctorAppointment appointment) throws RemoteException {
        return saveToMedicalHistory(appointment);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("===========================================");
            System.out.println("Doctor RMI Server Started Successfully!");
            System.out.println("===========================================");
            System.out.println("Service Name: DoctorService");
            System.out.println("Registry Port: 1235");
            System.out.println("Server Status: Running");
            System.out.println("===========================================");
            System.out.println("Data Loaded:");
            System.out.println("  - Doctors: " + server.doctors.size());
            System.out.println("  - Patients: " + server.patients.size());
            int totalAppointments = 0;
            for (List<DoctorAppointment> list : server.doctorAppointments.values()) {
